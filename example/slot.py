...
from PyQt5.QtWidgets import QWidget, QLabel, QScrollArea, QVBoxLayout, QHBoxLayout, QPushButton, QApplication
from PyQt5.QtGui import QPalette


class MyWindow(QWidget):
    # 声明一个信号 只能放在函数的外面
    my_signal: QObject = pyqtSignal(str)
    ...
    def init_ui(self):
        ...
        self.scroll.setWidget(self.msg)
